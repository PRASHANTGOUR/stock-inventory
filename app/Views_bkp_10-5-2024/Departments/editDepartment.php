          ...
          <div class="row justify-content-center">
            ...
            <div class="form-group">
                <h3>Edit Department</h3>
                  ...
                  <input type="text" class="form-control form-control-lg" name="department" id="department" value="<?php echo $result['department']; ?>" required>
                </div>
                <div class="form-group">
                  <label for="color_code" class="col-form-label-lg">Color</label>
                  <input type="color" class="form-control form-control-lg" name="color_code" id="color_code" value="<?php echo $result['color_code'];?>" required>
                </div>
