			...
			<div class="page d-flex flex-row flex-column-fluid">
					...
					<div class="aside-menu flex-column-fluid ps-3 pe-1">
						...
						<div class="menu menu-sub-indention menu-column menu-rounded menu-title-gray-600 menu-icon-gray-500 menu-active-bg menu-state-primary menu-arrow-gray-500 fw-semibold fs-6 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
                            ...
                            <!--begin:Menu item-->
								...
								<?php 
                                if (auth()->user()->can('production.access')) { 
                                ?>
                                    <!--begin:Menu item-->
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        <!--begin:Menu link-->
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
											...
											<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
												<a href="#" class="menu-link px-5">
													...
													<img class="w-15px h-15px rounded-1 ms-2" src="/public/assets/media/flags/<?=$flag?>.svg" alt="" /></span></span>
												</a>
												<!--begin::Menu sub-->
												...
												<div class="menu-sub menu-sub-dropdown w-175px py-4">
													...
													<div class="menu-item px-3">
														...
														<span class="symbol symbol-20px me-4">
															<img class="rounded-1" src="/public/assets/media/flags/united-kingdom.svg" alt="" />
														</span>English</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
														...
														<span class="symbol symbol-20px me-4">
															<img class="rounded-1" src="/public/assets/media/flags/romania.svg" alt="" />
														</span>Română</a>
													</div>
													<!--end::Menu item-->
                                                    <!--begin::Menu item-->
													<div class="menu-item px-3">
														...
														<span class="symbol symbol-20px me-4">
															<img class="rounded-1" src="/public/assets/media/flags/hungary.svg" alt="" />
														</span>Maghiară</a>
													</div>
													<!--end::Menu item-->
												</div>
					...
					<div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content">
							<h1 style="padding-left: 1.3em;"><a href="javascript:window.history.go(-1);"><i class="bi bi-arrow-90deg-left"></i></a> <?php echo $this->renderSection('heading'); ?></h1>
