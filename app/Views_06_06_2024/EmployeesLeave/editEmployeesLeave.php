          ...
          <div class="row justify-content-center">
            <form action="" method="POST" id="frm_employees" > <!-- onsubmit="return fun_frm_employees_leave_submit()" -->
                ...
                <h3>Edit Employees Leave</h3>
                  ...
                  <input type="checkbox" name="all_employee" id="all_employee" value="1" <?php echo ($result['all_employee'] == 1)?'checked':''; ?> onchange="all_employee_changed(this)"/>
            </div>
            ...
            <div class="form-group">
                  ...
                  <select class="form-control form-control-lg" name="employee_id" id="edit_employee_id" required>
