              ...
              for($i; $i < $Count; $i++) { ?>
                <div class="card rounded-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label for="d_coef[<?php echo $i;?>]" class="col-form-label-lg">Realisation (Co-efficent) *</label>
                      <input type="number" step="any" class="form-control form-control-lg" min=0.001 name="d_coef[<?php echo $i;?>]" id="d_coef[<?php echo $i;?>]" required>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="d_department_id[<?php echo $i;?>]" class="col-form-label-lg">Team *</label>
                      <!-- Use $department_id to set the input field value -->
                      <select class="form-control form-control-lg" name="d_department_id[<?php echo $i;?>]" id="d_department_id[<?php echo $i;?>]" required>
                      <?php
                    ...
                    <?php 
                      if($Count == 1) {
                        if (auth()->user()->can('production.super')) { ?>}
                          ...
                          <label for="BulkUnallocate" class="col-form-label-lg">Do not allocate to team</label>
                          <input type="checkbox" name="BulkUnallocate" id="BulkUnallocate" value="Yes">
                      <?php 
                        }
                      } 
                    ?>
