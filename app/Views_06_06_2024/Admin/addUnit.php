        ...
        <div class="row justify-content-center">
          <div class="row justify-content-center">
            ...
            <div class="form-group">
                <h3>Add Products</h3>
                  <label for="type" class="col-form-label-lg">Normal or Sales Request?</label><br />
                  <input type="radio" name="type" value="normal" checked>Normal 
                  <input type="radio" name="type" value="salesRequest">Sales Request<br />
                  <label for="q" class="col-form-label-lg">How many different types of units?</label>
                ...
                <div class="card rounded-0">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group" <?php echo $hidden;?>>
                      <label for="d_pnumber[<?php echo $i;?>]" class="col-form-label-lg">P number <?=$astrik?></label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control form-control-lg" name="deadline[<?php echo $i;?>]" id="deadline[<?php echo $i;?>]">
                    </div>

                    <div class="form-group" <?php echo $hidden;?>>
                      <label for="d_aqcode"[<?php echo $i;?>] class="col-form-label-lg">AQ Code <?=$astrik?></label>
                    ...
                    <div class="form-group">
                        <label for="Notes[<?php echo $i;?>]" class="col-form-label-lg">Notes <?=($type == "salesRequest") ? "*" : "(Optional)"?></label>
                        <textarea class="form-control form-control-lg" name="Notes[<?php echo $i;?>]" id="Notes[<?php echo $i;?>]" minlength="5" <?=($type == "salesRequest") ? "required" : NULL?>></textarea>
                    </div>

                    <div class="form-group">
                        <label for="phase[<?php echo $i;?>]" class="col-form-label-lg">Phase <?=$astrik?></label>
                        <select class="form-control form-control-lg" name="phase[<?php echo $i;?>]" id="phase[<?php echo $i;?>]" <?=$Required; ?>>
                    ...
                    <div class="form-group">
                        <label for="d_statu[<?php echo $i;?>]s" class="col-form-label-lg">Status <?=$astrik?></label>
