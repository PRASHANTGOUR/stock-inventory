        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-title">
                    ...
                    <form method="post">
                      <div class="d-flex align-items-center position-relative my-1">
                          ...
                          &nbsp;&nbsp;<a href="<?= url_to('EmployeesTask::list') ?>"  class="btn btn-danger"><span class="text">Reset</span></a>
                      </div>
                    </form>
                    <!--end::Search-->
                </div>
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    <!--begin::Add product-->
                    <a href="<?= url_to('EmployeesTask::addEmployeesTask');?>" class="btn btn-primary">
                    <span class="icon text-white-600">
                      <i class="fas fa-plus-circle"></i>
                    </span>
                    <span class="text">Add Employees Task</span>
                  </a>
                    <!--end::Add product-->
                </div>
                <!--end::Card toolbar-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                    ...
                    foreach ($products as $product) {
                      ...
                      <tr>
                        ...
                        <?php if (auth()->user()->can('production.super')) { ?>
                          <a href="<?= url_to('EmployeesTask::editEmployeesTask')?>?p=<?= $product['id']; ?>">
