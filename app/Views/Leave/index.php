    ...
    <div class="container-xxl">
        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <!--begin::Card toolbar-->
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5"  style="display:none;">
                    <!--begin::Add product-->
                    <a href="<?= url_to('Leave::addLeave');?>" class="btn btn-primary">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                    ...
                    foreach ($products as $product) {
                      ...
                      <tr>
                        ...
                        <?php if (auth()->user()->can('employees.access')) { ?>
                          <a href="<?= url_to('Leave::editLeave')?>?p=<?= $product['id']; ?>">
