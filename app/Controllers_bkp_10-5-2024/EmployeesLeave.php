...

{
...

  {
    ...
    $data = [
      ...
      'EventDetails' => 'Status Changed to Deleted - Product ID:'.$id.'===='.json_encode($query),
    ...
    if($check){
        ...
        if($all_employee == 1){
            ...
            foreach($period as $dt) {
                ...
                $main_query = "SELECT * FROM 8yxzleave WHERE DATE(start_date) <= '".$check_date."' AND DATE(end_date) >= '".$check_date."'";
            ...
            foreach($employee_id as $employee_id_val){
                ...
                foreach($period as $dt) {
                    ...
                    $main_query = "SELECT * FROM 8yxzleave WHERE employee_id = '".$employee_id_val."' AND DATE(start_date) <= '".$check_date."' AND DATE(end_date) >= '".$check_date."'";
